        ...
        "
            ...
            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-center">
                ...
                <div wire:loading.remove wire:target="{{ $name }}">
                    <p class="mb-2 text-sm font-semibold text-gray-500 group-hover:text-primary-500">Click to upload or
                        drag and drop</p>
                    <p class="text-xs text-gray-500 group-hover:text-primary-500">{{ $title }}</p>
                </div>
                ...
                <div class="mt-1" wire:loading.flex wire:target="{{ $name }}" class="text-primary-500">
                    <div class="text-center">
                        <div class="flex items-center justify-center gap-2 px-5">
                            <svg class="text-primary-500 w-7 h-7 animate-spin" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="text-primary-400 animate-pulse">Processing Files</div>
                        </div>

                        <div class="w-full h-4 mt-2 overflow-hidden bg-white rounded-full" x-show="isUploading">
                            <span class="block h-full bg-primary-500 animate-pulse"
