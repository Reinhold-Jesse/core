    ...
    <div class="container px-5 mx-auto">
        <div class="flex justify-end gap-4 my-12">
            <button type="button" wire:click="cancel"
                class="flex items-center justify-center w-56 px-5 py-2 text-gray-400 bg-gray-300 border-0 rounded-md shadow-sm hover:text-white hover:bg-gray-500 default-transition">
                Abbrechen
            </button>
